# Contributing to UItron ●

Thank you for your interest in contributing to UItron. 
...
3. Follow the setup instructions in the [README.md](README.md) to get your local environment running.
4. Make changes with clear code comments explaining your approach. Try to follow existing conventions in the code.
5. Follow the [Code Formatting and Linting](https://github.com/JeanSd1/UItron/blob/main/CONTRIBUTING.md#code-formatting-and-linting) guide below.
...
Please pick up a task from [issues](https://github.com/JeanSd1/UItron/issues).

If you encounter a bug or have a feature in mind, [search if an issue already exists](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments). If a related issue doesn't exist, please [open a new issue](https://github.com/JeanSd1/UItron/issues/new/choose).
