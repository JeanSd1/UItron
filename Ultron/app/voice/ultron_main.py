...
class Ultron:
        ...
        if eh_pergunta:
            ...
            if resposta:
                ...
                if resposta_fallback:
                    ...
                    self.speaker.say(resposta_fallback)
                    return True
                else:
    ...
    def _responder_pergunta_simples(self, texto: str) -> str:
        ...
        if "quem é você" in texto_lower or "quem é o ultron" in texto_lower:
            return "Sou o Ultron, um assistente de voz inteligente. Posso abrir programas, pesquisar na internet, responder perguntas e executar comandos no Windows."

        # Como você funciona
        if "como você funciona" in texto_lower or "como funciona" in texto_lower:
            return "Funciono através de reconhecimento de voz. Você fala, eu entendo, analiso e respondo ou executo a ação."
